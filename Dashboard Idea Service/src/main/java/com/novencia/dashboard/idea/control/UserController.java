package main.java.com.novencia.dashboard.idea.control;
...
import main.java.com.novencia.dashboard.idea.CustomErrorType;
import main.java.com.novencia.dashboard.idea.model.User;
import main.java.com.novencia.dashboard.idea.service.UserService;
 ...
 // -------------------Retrieve All Users---------------------------------------------
    ...
    public ResponseEntity<?> createUser(@RequestBody User user, UriComponentsBuilder ucBuilder) {
        ...
        if (userService.isUserExist(user)) {
            ...
            return new ResponseEntity<Object>(new CustomErrorType("Unable to create. A User with name "),HttpStatus.CONFLICT);
        }
